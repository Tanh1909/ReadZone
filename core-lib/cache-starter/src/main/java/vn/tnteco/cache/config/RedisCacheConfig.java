...
import vn.tnteco.cache.config.serializer.RedisSerializerImpl;
...
public class RedisCacheConfig {
    ...
    public CacheManager redisCacheManager(
        ...
        for (Map.Entry<String, Long> cachesWithTtl : properties.getCacheExpirations().entrySet()) {
            config.put(cachesWithTtl.getKey(), this.createDefaultCacheConfiguration(properties, cachesWithTtl.getValue()));
        }
