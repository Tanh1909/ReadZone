package vn.tnteco.cache.config.properties;
...
@Getter
@Configuration
@ConfigurationProperties("external-cache")
public class ExternalCacheConfigProperties extends Config {

    private Boolean enable;
    private String applicationCache = "DEFAULT";
    private String delimiter = "::";
    private Boolean isGenKey = Boolean.TRUE;
